...
public class PersonalMemberPO extends BasePO {
    ...
    public boolean equals(Object o) {
        ...
        PersonalMemberPO that = (PersonalMemberPO) o;
        ...
        if (memberAccount != null ? !memberAccount.equals(that.memberAccount) : that.memberAccount != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (memberAccount != null ? memberAccount.hashCode() : 0);
        return result;
    }
}
