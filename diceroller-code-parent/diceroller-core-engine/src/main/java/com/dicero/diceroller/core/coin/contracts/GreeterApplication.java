...
public class GreeterApplication {
    ...
    public static void main(String[] args) throws Exception {
        new GreeterApplication().run();
    }

    private void run() throws Exception {

        // We start by creating a new web3j instance to connect to remote nodes on the network.
        // FIXME: "https://rinkeby.infura.io/<your token>"
        Web3j web3j = Web3j.build(new HttpService());  // FIXME: Enter your Infura token here;
        log.info("Connected to Ethereum client version: "
                + web3j.web3ClientVersion().send().getWeb3ClientVersion());

        String password = "dice007";
        String source = "/Users/zengningzhong/Documents/workspace-intellij-develop/diceroller/wallet/";
        File sourceFile = new File(source);
        String name = WalletUtils.generateFullNewWalletFile(password, sourceFile);
...
//                web3j, credentials,
//                "0x3ed1517e347ec7cdd268df5de37d125b154f0c22",  // you can put any address here
