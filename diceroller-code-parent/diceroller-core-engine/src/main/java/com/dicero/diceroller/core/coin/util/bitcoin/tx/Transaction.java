...
import com.dicero.diceroller.core.coin.util.bitcoin.Address;
import com.dicero.diceroller.core.coin.util.bitcoin.bip32.ECKey;
...
import com.dicero.diceroller.core.coin.util.bitcoin.tx.input.Input;
import com.dicero.diceroller.core.coin.util.bitcoin.tx.input.MultiSigScriptHashInput;
import com.dicero.diceroller.core.coin.util.bitcoin.tx.input.PublicKeyHashInput;
import com.dicero.diceroller.core.coin.util.bitcoin.tx.output.Output;
import com.dicero.diceroller.core.coin.util.bitcoin.util.ByteReader;
import com.dicero.diceroller.core.coin.util.bitcoin.util.ByteWriter;
