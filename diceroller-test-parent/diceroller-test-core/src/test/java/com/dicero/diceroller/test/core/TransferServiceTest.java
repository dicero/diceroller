 ...
 * @version 2017/11/18
 */
public class TransferServiceTest  extends AbstractEtheTest {
    ...
    public void testSendFunds() throws Exception {
        ...
        BigInteger txFees = txReceipt.send().getGasUsed().multiply(Web3jConstants.GAS_PRICE);

        assertFalse(txReceipt.send().getBlockHash().isEmpty());
    ...
    public void testTransactionAndBlockAttributes() throws Exception {
        ...
        EthBlock.Block blockByNumber = ethBlock.getBlock();
