...
import com.dicero.diceroller.service.callback.RechargeSettlementStatusCallback;
...
public class RechargeSettlementStrategy extends AbstractSettlementStrategy implements InterfaceSettlementService {
    ...
    public void settlement(SettlementOrderPO settlementOrderPO, TradeModeEnums tradeModeEnums) {
        super.settlement(settlementOrderPO, tradeModeEnums, new RechargeSettlementStatusCallback());
    }
